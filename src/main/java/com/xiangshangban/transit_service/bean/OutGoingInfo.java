...
public class OutGoingInfo {
    ...
    private String proposerId;          //外出人ID（当前登录用户的ID）
    private String proposerName;        //外出人姓名
    ...
    private String startTime;           //外出起始时间
    private String endTime;             //外出结束时间
    private String effectiveTimeLength; //外出有效时长
    private String unit;                //外出的计算单位
