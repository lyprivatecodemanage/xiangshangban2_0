...
public class OverWorkInfo {
    ...
    private String proposerId;          //加班人ID（当前登录用户的ID）
    private String proposerName;        //加班人姓名
    ...
    private String startTime;           //加班起始时间
    private String endTime;             //加班结束时间
    private String effectiveTimeLength; //加班有效时长
    private String calculateType;       //加班的计算方式
